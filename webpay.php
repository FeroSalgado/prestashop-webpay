...
class WebPay extends PaymentModule {
    ...
    public function hookPayment($params){
        ...
        $this->context->smarty->assign(array(
            'logo' =>  'modules/webpay/images/logo-small.png',
            'title' => 'Pago con Tarjetas de Credito o Redcompra'
        ));

        return $this->display(__FILE__, 'views/templates/hook/payment_v1-6-x.tpl');
    }
